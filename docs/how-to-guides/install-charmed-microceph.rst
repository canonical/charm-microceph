...
The guide shows how to perform a general install of MicroCeph with Juju.

What you will need
------------------

- A snapd-compatible host to run the `Juju client <https://juju.is/docs/installing>`_
- A `MAAS cluster <https://maas.io/install>`_ (with a user account at your disposal)
  (OR)
  A `Manual cloud cluster <https://juju.is/docs/olm/manual-setup>`_
