...
For further details consult the `Juju documentation on LXD <https://documentation.ubuntu.com/juju/3.6/reference/cloud/list-of-supported-clouds/the-lxd-cloud-and-juju/#the-lxd-cloud-and-juju>`_.
...
To see how to configure and integrate MicroCeph with other Juju applications, see `the MicroCeph page on Charmhub <https://charmhub.io/microceph>`_.
