...
from ops.model import MaintainanceStatus
...
class MicroCephRemote(Object):
    ...
    # local state to check if remote data has changed.
    _stored = StoredState()
    ...
    def __init__(self, charm, relation_name="remote") -> None:
        ...
        self.framework.observe(charm.on[relation_name].broken, self._on_departed)
